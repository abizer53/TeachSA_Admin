    ...
    <>
      <div className={cn('wrapper flex flex-wrap items-start', className)}>
        ...
        <div className='w-full flex flex-wrap items-start'>
          <div className='w-full shadow-searchbox sticky top-0 z-20 bg-white flex flex-wrap items-center justify-between h-24 px-4'>
            <h2 className='text-black font-bold text-xl pl-4'>Hello Good Day,<span className='text-green'> Admin</span></h2>
            {/* <div className='flex items-center justify-end gap-10'>
              ...
              <div className='cursor-pointer relative flex items-center font-semibold font-sora'>
                <img className='size-9 rounded-full border-2 border-green shadow object-cover' src="/images/thumbnail.png" />
                <div className='flex flex-wrap ml-2.5'>
                  <span className='w-full text-[13px] text-green font-semibold font-sora'>Hello</span>
                  <span className='w-full text-sm text-green font-sora font-bold'>Admin</span>
                </div>
