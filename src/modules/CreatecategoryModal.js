...
import { createCategory } from '@/services/APIs/categories'
        ...
        <div className='modal-container'>
            <form onSubmit={submitHandler} className='bg-white rounded-lg p-8 w-1/3 max-h-[95vh] overflow-y-auto dropdown'>
                <div className='flex items-center justify-between'>
                    <h4 className='text-black font-sans text-2xl font-semibold'>Create Category</h4>
                ...
                <label className="flex flex-wrap mt-10">
                    ...
                    <Input type="text" name="name" placeholder="Enter category name" invalidmessage="Please enter a category name" />
                </label>
                ...
                <div className={`w-full grid grid-cols-2 gap-5 mt-3`}>
                    ...
                    <Button variant={"green"} loading={loading} className="mt-6 cursor-pointer">Create</Button>
                </div> 
            </form>
        </div>
    )
